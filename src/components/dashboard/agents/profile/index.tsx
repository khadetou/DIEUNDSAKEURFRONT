        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="row user-info">
              ...
              <div className="col-xl-3 xl-6 follow-list-item col-md-6">
                      ...
                      <ul>
                        <li>
                          <div className="media">
                            ...
                            <div className="media-body">
                              <h6>Bob Frapples</h6>
                              <span className="light-font">bobf@gmail.com</span>
                            </div>
                        ...
                        <li>
                          <div className="media">
                            ...
                            <div className="media-body">
                              <h6>Zack Lee</h6>
                              <span className="light-font">zack@gmail.com</span>
                            </div>
              ...
              <div className="col-xl-4 xl-6 col-md-6">
                        ...
                        <div className="table-responsive">
                          <table className="table table-bordernone mb-0">
                            <tbody>
                              <tr>
                                <td>Email:</td>
                                <td className="light-font">zackle@gmail.com</td>
                              </tr>
                              <tr>
                                <td>Mobile Number:</td>
                              ...
                              <tr>
                                <td>Gender:</td>
                                <td className="light-font">Female</td>
                              </tr>
                              <tr>
                                <td className="pb-0">DOB:</td>
                                <td className="pb-0 light-font">
                                  Oct, 15 1993
                                </td>
                              </tr>
                            </tbody>
              ...
              <div className="col-xl-3 xl-6 col-lg-12 col-md-5 xl-index-10">
                <div className="about-profile row">
                  <div className="col-xl-12 xl-12 col-lg-6">
                    <div className="card">
                      <div className="card-body">
                  ...
                  <div className="about-info col-xl-12 xl-6 col-lg-6  friend-agent">
                    <div className="card">
                      <div className="card-body">
                        <div className="title-about">
                          <h5>Friends</h5>
                        ...
                        <div className="friend-list">
                          <ul className="row">
                            <li className="col-md-4 col-sm-3 col-4 xl-2">
                              <img
                                src="/images/avatar/9.jpg"
                                className="img-fluid img-50"
                                alt=""
              ...
              <div className="col-xl-3 xl-6 col-md-12">
                <div className="row">
                  ...
                  <div className="col-xl-12 col-md-6">
                    <div className="card timeline-card timeline-agent">
                      <div className="card-body">
                        <div className="partner-info">
                          <div className="title-about">
...
export default BodyAgentProfile;
